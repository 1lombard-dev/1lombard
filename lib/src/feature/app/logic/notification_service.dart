...
//       // if (data.type == 'new_order_come_to_client') {
//       //   context.router.replaceAll([
//       //     const LauncherRoute(),
//       //     const MyOrdersRoute(),
//       //   ]);
//       // } else if (data.type == 'wait_order_come_to_client') {
//       //   context.router.replaceAll([
//       //     const LauncherRoute(),
//       //     const MyOrdersRoute(),
//       //   ]);
//       // } else if (data.type == 'send_courier_order_come_to_client') {
//       //   context.router.replaceAll([
//       //     const LauncherRoute(),
//       //     const MyOrdersRoute(),
//       //   ]);
//       // } else if (data.type == 'success_order_come_to_client') {
//       //   context.router.replaceAll([
//       //     const LauncherRoute(),
//       //     const MyOrdersRoute(),
//       //   ]);
//       // } else if (data.type == 'new_message_come_to_client') {
//       //   context.router.replaceAll([
//       //     const LauncherRoute(),
//       //     const ChatsRoute(),
//       //   ]);
...
//       await authDao.deviceToken.setValue(deviceToken);
//     }
//     log('$deviceToken', name: '0-0-0-0-0-0-');
//     return deviceToken;
//   }
